class Motores:
    ...
    def fazer_curva_dir_esteira(self, velocidade, tempo=0):
        ...
        if tempo != 0:
            ...
            self.m_direito.run_forever(speed_sp=velocidade * -1, stop_action='brake')
            self.m_esquerdo.run_forever(speed_sp=velocidade, stop_action='brake')

    def fazer_curva_esq_esteira(self, velocidade, tempo=0):
        ...
        if tempo != 0:
            ...
            self.m_direito.run_forever(speed_sp=velocidade, stop_action='brake')
            self.m_esquerdo.run_forever(speed_sp=velocidade * -1, stop_action='brake')
